...
export default {
  ...
  updateTrip: async (tripId, progress, userId, tripTime, endTrip, userName) => {
    return await axios.post("/googlemap/updateTrip", { tripId, progress, userId, tripTime, endTrip, userName });
  },
  // Saves a trip to the database
